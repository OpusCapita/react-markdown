...
describe('<MarkdownStrikethroughButton/>', () => {
  it('check active button', () => {
    ...
    const wrapper = shallow(<MarkdownStrikethroughButton state={state} onChange={() => {}} />);
  ...
  it('check mark selected text', () => {
    ...
    const wrapper = shallow(
      <MarkdownStrikethroughButton state={state} onChange={(newState) => { state = newState }} />
    );

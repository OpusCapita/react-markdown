...
describe('<MarkdownItalicButton/>', () => {
  it('check active button', () => {
    ...
    const wrapper = shallow(<MarkdownItalicButton state={state} onChange={() => {}} />);
  ...
  it('check mark selected text', () => {
    ...
    const wrapper = shallow(<MarkdownItalicButton state={state} onChange={(newState) => { state = newState }} />);
